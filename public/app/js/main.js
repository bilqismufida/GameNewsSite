$(document).ready(function() {
    ...
    //         navbar.style.paddingBottom = "50px"; // Adjust the padding-bottom value as needed
    //     } else {
    //         navbar.classList.remove("sticky");
    //         navbar.style.paddingBottom = "0"; // Reset padding when sticky is removed
    //     }
    // }
...
function stickFunction() {
    if (window.innerWidth <= 757) {  // Sticky effect for medium and small screens (max-width 991px)
        if (window.scrollY >= sticky) {
            navbar.classList.add("sticky");
            navbar.style.paddingBottom = "50px"; // Adjust the padding-bottom value as needed
        } else {
        ...
        navbar.classList.remove("sticky");
        navbar.style.paddingBottom = "0"; // Reset padding if screen width is larger than 991px
    }
}
