                ...
                <div class="col-lg-8 top-post-left">
                    <?php if (isset($topSelectedPosts[0])) {
                        ...
                        <div class="top-post-details">
                            <ul class="tags">
                                <li><a
                                        href="<?= url('show-category/' . $topSelectedPosts[0]['cat_id']) ?>"><?= $topSelectedPosts[0]['category'] ?></a>
                                </li>
                            </ul>
                            ...
                            <ul class="meta">
                                <li><a href="#" style="color: black;"><span class="lnr lnr-user"
                                            style="color: black;"></span><?= $topSelectedPosts[0]['username'] ?></a></li>
                                <li><a href="#" style="color: black;"><?= $topSelectedPosts[0]['created_at'] ?><span
                                            class="lnr lnr-calendar-full" style="color: black;"></span></a></li>
                                <li><a href="#" style="color: black;"><?= $topSelectedPosts[0]['comments_count'] ?><span
                                            class="lnr lnr-bubble" style="color: black;"></span></a></li>
                            </ul>
                        </div>
                    <?php } ?>
                </div>
                    ...
                    <?php if (isset($topSelectedPosts[1])) { ?>
                        ...
                        <div class="single-top-post">
                            ...
                            <div class="top-post-details">
                                <ul class="tags">
                                    <li><a
                                            href="<?= url('show-category/' . $topSelectedPosts[1]['cat_id']) ?>"><?= $topSelectedPosts[1]['category'] ?></a>
                                    </li>
                                </ul>
                                ...
                                <ul class="meta">
                                    <li><a href="#"><span
                                                class="lnr lnr-user"></span><?= $topSelectedPosts[1]['username'] ?></a></li>
                                    <li><a href="#"><?= $topSelectedPosts[1]['created_at'] ?><span
                    ...
                    if (isset($topSelectedPosts[2])) { ?>
                        <div class="single-top-post mt-10">
                            ...
                            <div class="top-post-details">
                                <ul class="tags">
                                    <li><a
                                            href="<?= url('show-category/' . $topSelectedPosts[2]['cat_id']) ?>"><?= $topSelectedPosts[2]['category'] ?></a>
                                    </li>
                                </ul>
                                ...
                                <ul class="meta">
                                    <li><a href="#"><span
                                                class="lnr lnr-user"></span><?= $topSelectedPosts[2]['username'] ?></a></li>
                                    <li><a href="#"><?= $topSelectedPosts[2]['created_at'] ?><span
                                                class="lnr lnr-calendar-full"></span></a></li>
                ...
                <?php if (!empty($breakingNews)) { ?>
                    <div class="col-lg-12">
                        <div class="news-tracker-wrap text-left">
                            <h6><span> Breaking News :</span> <a
                                    href="<?= url('show-post/' . $breakingNews['id']) ?>"><?= $breakingNews['title'] ?></a>
                            </h6>
                        </div>
                    </div>
                <?php } ?>
                        ...
                        <?php foreach ($lastPosts as $lastPost) { ?>
                            <div class="single-latest-post row align-items-center">
                                <div class="col-lg-5 post-left">
                                    ...
                                    <ul class="tags">
                                        <li><a
                                                href="<?= url('show-category/' . $lastPost['cat_id']) ?>"><?= $lastPost['category'] ?></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-lg-7 post-left text-left">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li><a href="#"><?= $lastPost['created_at'] ?><span
                                                    class="lnr lnr-calendar-full"></span></a></li>
                        ...
                        <?php if (isset($popularPosts[0])) { ?>
                            <div class="feature-post relative post-left text-left">
                                ...
                                <div class="details post-left text-left">
                                    <ul class="tags">
                                        <li><a
                                                href="<?= url('show-category/' . $popularPosts[0]['cat_id']) ?>"><?= $popularPosts[0]['category'] ?></a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="meta">
                                        <li><a href="#"><span
                                                    class="lnr lnr-user"></span><?= $popularPosts[0]['username'] ?></a></li>
                                        <li><a href="#"><?= $popularPosts[0]['created_at'] ?><span
                                                    class="lnr lnr-calendar-full"></span></a></li>
                                        <li><a href="#"><?= $popularPosts[0]['comments_count'] ?><span
                                                    class="lnr lnr-bubble"></span></a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <?php if (isset($popularPosts[1])) { ?>
                                <div class="col-lg-6 single-popular-post">
                                    <div class="feature-img-wrap relative">
                                        ...
                                        <ul class="tags">
                                            <li><a
                                                    href="<?= url('show-category/' . $popularPosts[1]['cat_id']) ?>"><?= $popularPosts[1]['category'] ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="details post-left text-left">
                                        ...
                                        <ul class="meta">
                                            <li><a href="#"><span
                                                        class="lnr lnr-user"></span><?= $popularPosts[1]['username'] ?></a>
                                            </li>
                                            <li><a href="#"><?= $popularPosts[1]['created_at'] ?><span
                                                        class="lnr lnr-calendar-full"></span></a></li>
                                            <li><a href="#"><?= $popularPosts[1]['comments_count'] ?><span
                                                        class="lnr lnr-bubble"></span></a></li>
                                        </ul>
                                ...
                                <div class="col-lg-6 single-popular-post">
                                    <div class="feature-img-wrap relative">
                                        ...
                                        <ul class="tags post-left text-left">
                                            <li><a
                                                    href="<?= url('show-category/' . $popularPosts[2]['cat_id']) ?>"><?= $popularPosts[2]['category'] ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="details post-left text-left">
                                        ...
                                        <ul class="meta">
                                            <li><a href="#"><span
                                                        class="lnr lnr-user"></span><?= $popularPosts[2]['username'] ?></a>
                                            </li>
                                            <li><a href="#"><?= $popularPosts[2]['created_at'] ?><span
                                                        class="lnr lnr-calendar-full"></span></a></li>
                                            <li><a href="#"><?= $popularPosts[2]['comments_count'] ?><span
                                                        class="lnr lnr-bubble"></span></a></li>
                                        </ul>
                                        <p class="excert post-left text-left">
