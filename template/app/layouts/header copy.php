            ...
            <div class="container">
                <div class="row text-left float-left mb-10">
                    ...
                    <div class="header-top-left no-padding ">
                        <ul>
                            <li><a href="<?= url('login') ?>"><span class="lnr lnr-enter-down"></span><span
                                        style="font-size:15px;"> Login</span></a></li>
                            <li><a href="<?= url('register') ?>"><span class="lnr lnr-user"></span><span
                                        style="font-size:15px;"> Register</span></a></li>
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-4 col-md-4 col-sm-12 logo-left no-padding">
                        <a href="http://localhost/GameNewsSite/">
        ...
        <div class="container main-menu" id="main-menu">
            <div class="row align-items-center justify-content-between">
                <div class="navbar-right">
                    <form class="Search">
                        <input type="text" class="form-control Search-box text-left" name="Search-box" id="Search-box"
                            placeholder="Search">
