    ...
    <?php 
        //require_once('app/layout/trending.php');
    ?>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="single-post-area mb-80">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <a href="single-post.php" class="post-title">Searching for the 'angel' who held me on Westminste Bridge</a>
                                        <div class="post-meta d-flex">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="single-post-area mb-80">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <a href="single-post.php" class="post-title">Love Island star's boyfriend found dead after her funeral</a>
                                        <div class="post-meta d-flex">
                                ...
                                <div class="sport-video-slides owl-carousel mb-50">
                                    ...
                                    <div class="single-post-area">
                                        ...
                                        <div class="post-content">
                                            ...
                                            <a href="single-post.php" class="post-title">Searching for the 'angel' who held me on Westminster Bridge</a>
                                            <div class="post-meta d-flex">
                                                <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 14</a>
                                                <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 38</a>
                                                <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 22</a>
                        ...
                        <div class="row mb-30">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="single-blog-post style-3 d-flex mb-50">
                                    ...
                                    <div class="post-content">
                                        <a href="single-post.php" class="post-title">Epileptic boy's cannabis let through border</a>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="single-blog-post style-3 d-flex mb-50">
                                    ...
                                    <div class="post-content">
                                        <a href="single-post.php" class="post-title">Paramedics 'drilled into boat death woman'</a>
                                        <div class="post-meta d-flex justify-content-between">
                                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 16</a>
                                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 26</a>
                                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 17</a>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="single-blog-post style-3 d-flex mb-50">
                                    ...
                                    <div class="post-content">
                                        <a href="single-post.php" class="post-title">Tory vice-chairs quit over PM's Brexit plan</a>
                                        <div class="post-meta d-flex justify-content-between">
                                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 16</a>
                                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 26</a>
                                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 17</a>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="single-blog-post style-3 d-flex mb-50">
                                    ...
                                    <div class="post-content">
                                        <a href="single-post.php" class="post-title">Do This One Simple Action for an Absolutely</a>
                                        <div class="post-meta d-flex justify-content-between">
                                            <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 16</a>
                                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 26</a>
                                            <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 17</a>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="post-content mt-0">
                                        <a href="#" class="post-cata cata-sm cata-success">Sports</a>
                                        <a href="single-post.php" class="post-title mb-2">May fights on after Johnson savages Brexit approach</a>
                        ...
                        <div class="single-post-area mb-30">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="post-content mt-0">
                                        <a href="#" class="post-cata cata-sm cata-danger">Game</a>
                                        <a href="single-post.php" class="post-title mb-2">Thailand cave rescue: Boys 'doing well' after spending night</a>
                                        <div class="post-meta d-flex align-items-center mb-2">
                                            <a href="#" class="post-author">By Jane</a>
                                            <i class="fa fa-circle" aria-hidden="true"></i>
                                            <a href="#" class="post-date">Sep 08, 2018</a>
                        ...
                        <div class="single-post-area mb-30">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="post-content mt-0">
                                        <a href="#" class="post-cata cata-sm cata-primary">Business</a>
                                        <a href="single-post.php" class="post-title mb-2">Theresa May battles Brexiteer backlash amid disquiet</a>
                                        <div class="post-meta d-flex align-items-center mb-2">
                                            <a href="#" class="post-author">By Jane</a>
                                            <i class="fa fa-circle" aria-hidden="true"></i>
                                            <a href="#" class="post-date">Sep 08, 2018</a>
                        ...
                        <div class="single-post-area mb-30">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <div class="post-content mt-0">
                                        <a href="#" class="post-cata cata-sm cata-danger">Game</a>
                                        <a href="single-post.php" class="post-title mb-2">Theresa May warned Brexit strategy 'risks putting Jeremy Corbyn</a>
                                        <div class="post-meta d-flex align-items-center mb-2">
                                            <a href="#" class="post-author">By Jane</a>
                                            <i class="fa fa-circle" aria-hidden="true"></i>
                                            <a href="#" class="post-date">Sep 08, 2018</a>
