...
<!-- 
                        ...
                        <?php } else { ?>
                            <a role="button" class="btn btn-sm btn-warning text-white"
                                href="<?= url('admin/user/permission/' . $user['id']) ?>">click not to be admin</a>
                        <?php } ?> -->


                        <a role="button" class="btn btn-sm btn-primary text-white"
                            href="<?= url('admin/user/edit/' . $user['id']) ?>">edit</a>
                        <a onclick="return confirm('Apakah anda yakin ingin menghapus akun ini?');" role="button" class="btn btn-sm btn-danger text-white"
